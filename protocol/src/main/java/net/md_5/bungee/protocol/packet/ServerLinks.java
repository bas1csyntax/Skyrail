...
public class ServerLinks extends DefinedPacket
{
    ...
    public void read(ByteBuf buf, ProtocolConstants.Direction direction, int protocolVersion)
    {
        ...
        for ( int i = 0; i < len; i++ )
        {
            Either<LinkType, Deserializable<Either<String, SpecificTag>, BaseComponent>> type;
            if ( buf.readBoolean() )
            {
    ...
    public void write(ByteBuf buf, ProtocolConstants.Direction direction, int protocolVersion)
    {
        ...
        for ( Link link : links )
        {
            Either<LinkType, Deserializable<Either<String, SpecificTag>, BaseComponent>> type = link.getTypeRaw();
            if ( type.isLeft() )
            {
    ...
    public static class Link
    {
        ...
        private final Either<LinkType, Deserializable<Either<String, SpecificTag>, BaseComponent>> typeRaw;
